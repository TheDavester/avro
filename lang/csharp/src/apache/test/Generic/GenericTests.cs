...
namespace Avro.Test.Generic
{
    class GenericTests
    {
	    ...
	    public void TestUnion_enum_Throws(string unionSchema, string enumSchema, string value)
	    {
			Assert.That(() => test(unionSchema, mkEnum(enumSchema, value)), Throws.TypeOf<AvroException>());
		}
	    ...
	    public void TestUnion_fixed_Throws(string unionSchema, string fixedSchema, byte[] value)
	    {
			Assert.That(() => test(unionSchema, mkFixed(fixedSchema, value)), Throws.TypeOf<AvroException>());
		}
	    ...
	    [TestCase("boolean", true, "null")]
	    [TestCase("int", 10, "boolean")]
	    [TestCase("int", 10, "string")]
	    [TestCase("int", 10, "bytes")]
	    [TestCase("int", 10, "{\"type\":\"record\",\"name\":\"r\",\"fields\":[{\"name\":\"f\", \"type\":\"int\"}]}")]
	    [TestCase("int", 10, "{\"type\":\"enum\",\"name\":\"e\",\"symbols\":[\"s\", \"t\"]}")]
	    [TestCase("int", 10, "{\"type\":\"array\",\"items\":\"int\"}")]
	    [TestCase("int", 10, "{\"type\":\"map\",\"values\":\"int\"}")]
	    [TestCase("int", 10, "[\"string\", \"bytes\"]")]
	    [TestCase("int", 10, "{\"type\":\"fixed\",\"name\":\"f\",\"size\":2}")]
	    [TestCase("{\"type\":\"array\",\"items\":\"int\"}", new[] {10}, "\"boolean\"")]
	    [TestCase("{\"type\":\"array\",\"items\":\"int\"}", new[] {10}, "{\"type\":\"array\",\"items\":\"string\"}")]
	    ...
	    {
		    Assert.That(() => testResolutionMismatch(writerSchema, value, readerSchema), Throws.TypeOf<AvroException>());
	    }

        [TestCase("{\"type\":\"record\",\"name\":\"r\",\"fields\":" +
            "[{\"name\":\"f1\",\"type\":[\"int\", \"null\"]},{\"name\":\"f2\",\"type\":\"int\"}]}",
            new object[] { "f1", 101, "f2", 100 }, "int", Description = "Non-record schema")]
        [TestCase("{\"type\":\"record\",\"name\":\"r\",\"fields\":" +
            "[{\"name\":\"f1\",\"type\":[\"int\", \"null\"]},{\"name\":\"f2\",\"type\":\"int\"}]}",
            new object[] { "f1", 101, "f2", 100 },
            "{\"type\":\"record\",\"name\":\"s\",\"fields\":" +
            "[{\"name\":\"f2\",\"type\":\"int\"}]}", Description = "Name mismatch")]
        [TestCase("{\"type\":\"record\",\"name\":\"r\",\"fields\":" +
            "[{\"name\":\"f1\",\"type\":[\"int\", \"null\"]},{\"name\":\"f2\",\"type\":\"int\"}]}",
            new object[] { "f1", 101, "f2", 100 },
            "{\"type\":\"record\",\"name\":\"r\",\"fields\":" +
            "[{\"name\":\"f2\",\"type\":\"string\"}]}", Description = "incompatible field")]
        [TestCase("{\"type\":\"record\",\"name\":\"r\",\"fields\":" +
            "[{\"name\":\"f1\",\"type\":[\"int\", \"null\"]},{\"name\":\"f2\",\"type\":\"int\"}]}",
            new object[] { "f1", 101, "f2", 100 },
            "{\"type\":\"record\",\"name\":\"r\",\"fields\":" +
            "[{\"name\":\"f3\",\"type\":\"string\"}]}", Description = "new field without default")]
        public void TestResolutionMismatch_record(string ws, object[] actual, string rs)
        {
			Assert.That(() => testResolutionMismatch(ws, mkRecord(actual, Schema.Parse(ws) as RecordSchema), rs), Throws.TypeOf<AvroException>());
		}

        [TestCase("{\"type\":\"enum\",\"name\":\"e\",\"symbols\":[\"s\", \"t\"]}", "s", "int",
	        Description = "Non-enum schema")]
        [TestCase("{\"type\":\"enum\",\"name\":\"e\",\"symbols\":[\"s\", \"t\"]}",
            "s", "{\"type\":\"enum\",\"name\":\"f\",\"symbols\":[\"s\", \"t\"]}",
            Description = "Name mismatch")]
        [TestCase("{\"type\":\"enum\",\"name\":\"e\",\"symbols\":[\"s\", \"t\"]}",
            "s", "{\"type\":\"enum\",\"name\":\"f\",\"symbols\":[\"t\", \"u\"]}",
            Description = "Incompatible symbols")]
        public void TestResolutionMismatch_enum(string ws, string value, string rs)
        {
	        Assert.That(() => testResolutionMismatch(ws, mkEnum(ws, value), rs), Throws.TypeOf<AvroException>());
        }

        [TestCase("{\"type\":\"map\",\"values\":\"int\"}", new object[] { "a", 0 }, "int",
            Description = "Non-map schema")]
        ...
        {
	        Assert.That(() => testResolutionMismatch(ws, mkMap(value), rs), Throws.TypeOf<AvroException>());
        }

        [TestCase("{\"type\":\"fixed\",\"name\":\"f\",\"size\":2}", new byte[] { 1, 1 }, "int",
            Description = "Non-fixed schema")]
        ...
        {
	        Assert.That(() => testResolutionMismatch(ws, mkFixed(ws, value), rs), Throws.TypeOf<AvroException>());
        }
