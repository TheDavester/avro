...
namespace Avro.Test
{
    ...
    public class SchemaTests
    {
        ...
        [TestCase("{\"type\": \"enum\", \"name\": \"Status\", \"symbols\": \"Normal Caution Critical\"}",
            Description = "Symbols not an array")]
        [TestCase("{\"type\": \"enum\", \"name\": [ 0, 1, 1, 2, 3, 5, 8 ], \"symbols\": [\"Golden\", \"Mean\"]}",
            Description = "Name not a string")]
        ...
        [TestCase("{\"type\": \"fixed\", \"size\": 314}",
            Description = "No name")]
        public void TestBasicThrowsWhenInvalid(string s)
        {
            Assert.That(()=>Schema.Parse(s), Throws.TypeOf<SchemaParseException>());
        }
